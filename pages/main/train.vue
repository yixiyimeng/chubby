	...
	<view class="content">
		...
		<view v-show="close" style="position: absolute;top: 0;width: 750rpx;height: 100%;background-color: rgba(0,0,0,0.5);">
			<view style="width: 690rpx;height: 750rpx;background-color: #FFFFFF;border-radius: 20rpx;margin: auto;margin-top: 200rpx;">
				...
				<view>
					<view style="display: inline-block;width: 345rpx;"><view class="btn2 btn-white" @click="cxcs()">重新测试</view></view>
					<view style="display: inline-block;width: 345rpx;"><view class="btn2 btn-red" @click="closedom()">关闭</view></view>
				</view>
			</view>
		</view>
	</view>
